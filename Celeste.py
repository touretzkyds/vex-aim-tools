...
class Celeste(StateMachineProgram):
    ...
    class CmdSearch(StateNode, LooseSpec):
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Wed Aug 12 18:39:44 2026:
    ...
    def setup(self):
        ...
        datatrans9 .add_sources(dispatch) .add_destinations(say)
        ...
        timertrans3 .add_sources(say) .add_destinations(statenode1)
        ...
        timertrans4 .add_sources(script) .add_destinations(statenode2)
