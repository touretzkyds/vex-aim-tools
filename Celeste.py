...
class Celeste(StateMachineProgram):
    ...
    class CmdHang(StateNode):
        def start(selv,event):
            super().start(event)
            print("I am now hung.")
    ...
    class CmdSearch(StateNode, LooseSpec):
        ...
        def setup(self):
            ...
            # Code generated by genfsm on Mon Aug 17 11:46:15 2026:
    ...
    def setup(self):
        ...
        # 
        #         reset_fsm: Say(["I'm awake", "state machine reset", "Back on the job", "Ready for action",
